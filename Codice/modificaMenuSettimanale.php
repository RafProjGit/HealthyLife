<html>
	...
	<form action=homePagePaziente target="_blank">
		...
		<input type="reset" id="BottoneReset" name="BottoneReset" value="Elimina tutto">
	</form>
	
	<form method=post action=controllaValoriEsatti target="_blank">
		<input type="submit" id="BottoneInvioMoudulo" name="BottoneInvioMoudulo" value="Invia">
	</form>
