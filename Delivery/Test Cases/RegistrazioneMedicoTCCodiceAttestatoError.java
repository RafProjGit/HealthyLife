...
/**
 * Registrazione medico codice fiscale vuoto
 * Parametri
 * Nome: Vincenzo
 * Cognome: Nunziata
 * Indirizzo: Nel Mondo
 ...
 *
 */
public class RegistrazioneMedicoTCCodiceAttestatoError{
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[3]/td[2]/input")).sendKeys("");
