...
/**
 * Registrazione paziente citta di 31 caratteri
 * Parametri
 * Nome: Raffaele
 * Cognome: Cataletti
 * Indirizzo: Nel Mondo
 ...
 * Città di residenza: abcdefghijklmnopqrstuvwasdfghjp
 * 
 ...
 *
 */
public class RegistrazionePazienteTCCittaError2{
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[3]/td[2]/input")).sendKeys("abcdepghi1234lmn");
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[5]/td[2]/input")).sendKeys("abcdefghijklmnopqrstuvwasdfghjp");
		...
		"Valore non corretto per il campo Citta. Richiesti da 1 a 30 caratteri" 
				+ "')]"));
