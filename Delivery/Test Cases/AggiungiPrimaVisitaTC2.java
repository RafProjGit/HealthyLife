//Precondizione: deve esistere un medico nella località inserita
package tests;
...
public class AggiungiPrimaVisitaTC2 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath(".//*[@id='textNomeMedico']")).sendKeys("");
		driver.findElement(By.xpath(".//*[@id='textCognomeMedico']")).sendKeys("");
		driver.findElement(By.xpath("html/body/table/tbody/tr/td[1]/form/input[3]")).sendKeys("lolloland");
