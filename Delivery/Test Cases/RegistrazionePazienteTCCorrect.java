...
/**
 * Registrazione paziente avvenuta con successo
 * Parametri
 * Nome: Raffaele
 * Cognome: Cataletti
 * Indirizzo: Nel Mondo
 ...
 *
 */
public class RegistrazionePazienteTCCorrect {
	...
	public static void main(String[] args) {
		...
		List<WebElement> list = driver.findElements(By.xpath("//*[contains(text(),'" + "Operazione completata con successo" + "')]"));
		Assert.assertTrue(list.size() > 0, "Operazione completata con successo");
