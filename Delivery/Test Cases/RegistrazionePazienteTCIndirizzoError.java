...
/**
 * Registrazione paziente indirizzo vuoto
 * Parametri
 * Nome: Raffaele
 * Cognome: Cataletti
 * Indirizzo:
 ...
 *
 */
public class RegistrazionePazienteTCIndirizzoError {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[1]/td[4]/input")).sendKeys("");
