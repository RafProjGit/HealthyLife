...
/**
 * Registrazione paziente indirizzo email di 31 caratteri
 * Parametri
 * Nome: Raffaele
 * Cognome: Cataletti
 * Indirizzo: Nel Mondo
 * Codice Fiscale: abcdefghi1234lmn
 * Email: abcdefghijklmno@pqrstuvwxyz.com
 ...
 *
 */
public class RegistrazionePazienteTCEmailError3{
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[2]/td[4]/input")).sendKeys("abcdefghijklmno@pqrstuvwxyz.com");
