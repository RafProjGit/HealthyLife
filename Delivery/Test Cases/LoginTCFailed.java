...
public class LoginTCFailed {
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/div/center[1]/input[2]")).sendKeys("kjhgfdrtyhjhg");
		...
		org.testng.Assert.assertEquals(s, "Nome utente o password errati!");
