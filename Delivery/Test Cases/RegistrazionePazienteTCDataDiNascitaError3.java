...
/**
 * Registrazione paziente data di nascita con mese 13, giorno 32 e anno 1899
 * Parametri
 * Nome: Raffaele
 * Cognome: Cataletti
 * Indirizzo: Nel Mondo
 ...
 *
 */
public class RegistrazionePazienteTCDataDiNascitaError3{
	...
	public static void main(String[] args) {
		...
		try{
			...
			driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[4]/td[2]/input[1]")).sendKeys("32");
			driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[4]/td[2]/input[2]")).sendKeys("13");
			driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[4]/td[2]/input[3]")).sendKeys("1899");
