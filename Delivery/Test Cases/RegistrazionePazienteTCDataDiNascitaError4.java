...
/**
 * Registrazione paziente data di nascita con giorno 31 in mese di 30
 * Parametri
 * Nome: Raffaele
 * Cognome: Cataletti
 * Indirizzo: Nel Mondo
 ...
 *
 */
public class RegistrazionePazienteTCDataDiNascitaError4{
	...
	public static void main(String[] args) {
		...
		try{
			...
			driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[4]/td[2]/input[1]")).sendKeys("31");
			driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[4]/td[2]/input[2]")).sendKeys("06");
