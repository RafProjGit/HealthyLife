//Precondizione: deve essere il caso di test AggiungiVisitaTC
...
public class AggiungiVisitaTCFailed2 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/table/tbody/tr/td[1]/form/input[3]")).click();
       	List<WebElement> list = driver.findElements(By.xpath("//*[contains(text(),'" + "Visita non inserita. Esiste già una visita nello stesso orario." + "')]"));		    		
 
    	        Assert.assertTrue(list.size() > 0, 
					"Visita non inserita. Esiste già una visita nello stesso orario." 
