...
/**
 * Registrazione paziente cognome vuoto
 * Parametri
 * Nome: Raffaele
 * Cognome: 
 * Indirizzo: Nel Mondo
 ...
 *
 */
public class RegistrazionePazienteTCCognomeError {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[2]/td[2]/input")).sendKeys("");
