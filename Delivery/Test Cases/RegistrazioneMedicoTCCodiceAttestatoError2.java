...
/**
 * Registrazione medico codice attestato di 17 cifre
 * Parametri
 * Nome: Vincenzo
 * Cognome: Nunziata
 * Indirizzo: Nel Mondo
 * Codice Attestato: abcdefghijklmnopq
 * Email: lol@lol.it
 ...
 *
 */
public class RegistrazioneMedicoTCCodiceAttestatoError2{
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[3]/td[2]/input")).sendKeys("abcdefghijklmnopq");
		...
		"Valore non corretto per il campo Codice Attestato. Richiesti esattamente 16 caratteri " 
				+ "')]"));
		Assert.assertTrue(list.size() > 0, 
				"Valore non corretto per il campo Codice Attestato. Richiesti esattamente 16 caratteri alfanumerici"
				);
