...
/**
 * Registrazione medico codice attestato di 15 cifre
 * Parametri
 * Nome: Vincenzo
 * Cognome: Nunziata
 * Indirizzo: Nel Mondo
 * Codice Attestato: abcdefghijklmno
 * Email: lol@lol.it
 ...
 *
 */
public class RegistrazioneMedicoTCCodiceAttestatoError3{
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[3]/td[2]/input")).sendKeys("abcdefghijklmno");
