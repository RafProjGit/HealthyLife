//Il test controlla che un campo non superi 150 caratteri, e lo proviamo inserendo un valore di 151 caratteri
...
public class ModificaMenuTCFailed2 {
		...
		public static void main(String[] args) {
			...
			String str="Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis pa";
			driver.findElement(By.xpath("html/body/table/tbody[2]/tr[4]/td[2]")).sendKeys(str);
			...
			//modifica l'asserzione con quello che vuoi. Questa cerca all'interno di tutta la pagina 
             ...
             org.testng.Assert.assertEquals(alert.getText(), "Limite di caratteri superato. Inserisci al massimo 150 caratteri ");    
