...
/**
 * Registrazione paziente password vuota
 * Parametri
 * Nome: Raffaele
 * Cognome: Cataletti
 * Indirizzo: Nel Mondo
 ...
 *
 */
public class RegistrazionePazienteTCPasswordError{
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("html/body/form/table/tbody/tr/td/table/tbody/tr[3]/td[4]/input")).sendKeys("");
