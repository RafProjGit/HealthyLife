...
public class AggiungiPazienteTCFailed2 {
		public static void main(String[] args) {
           ...
           List<WebElement> list = driver.findElements(By.xpath("//*[contains(text(),'" + "Non è stato trovato nessun paziente con la mail inserita" + "')]"));
			
			Assert.assertTrue(list.size() > 0, 
					"Non è stato trovato nessun paziente con la mail inserita" 
					);
